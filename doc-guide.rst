...
Clone the Project-FiFo Github documentation repository::
...
Edit your files and rebuild until you like what you see, then commit your changes and push to the public repository. Assuming the file you changed is called e.g. myfile.rst::
...
Use::
    ...
    .. image:: _static/images/fifo-docs-banner.png
        :width: 200px
        :align: center
        :height: 100px
        :alt: alternate text
...
::
    ...
    .. figure:: _static/images/fifo-docs-banner.png
        :width: 200px
        :align: center
        :height: 100px
        :alt: alternate text
...
glossary, centered, index and field list
=====================================================================
...
Directives can be used within aliases::
    ...
    .. |logo| image:: _static/images/fifo-docs-banner.png
        :width: 20pt
        :height: 20pt
